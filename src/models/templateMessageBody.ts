...
export const triggers = ["ENROLLMENT_ACCEPT", "REGISTRATION_REJECT", "PASSWORD_FORGOT", "SHIFT_ENROLL_REQUEST","SHIFT_ENROLL_CONFIRMATION" ,"SHIFT_ENROLL_REJECT", "SHIFT_ENROLL_INVITATION"];
